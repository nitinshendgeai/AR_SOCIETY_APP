...
Registers the "bank_reconciliation" screen in the forms navigation matrix
(see f6a7b8c9d0e1_online_payments_form.py for the identical pattern) so
the new statement-import/match screen is reachable from the drawer,
granted by default to the same roles as Online Payments: Society Admin,
all Committee roles, and Manager.
"""
...
FORM_CODE = "bank_reconciliation"
FORM_NAME = "Bank Reconciliation"
FORM_DESC = "Import bank statements and match them against pending payments"
